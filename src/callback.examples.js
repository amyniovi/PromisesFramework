...
test("Verbose, hard to reuse, easy to forget, additional error handling mechanism",
    done => {
...
//in Async tests with mocha we receive done and we call done once all the Async
//callbacks complete (otherwise timeout)
test('just freaking testing if we can grab city', done => {
